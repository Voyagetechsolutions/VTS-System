...
import {
  Edit as EditIcon, Cancel as CancelIcon, Visibility as VisibilityIcon
} from '@mui/icons-material';
import { supabase } from '../../../supabase/client';
import EditTripModal from './EditTripModal';

export default function TripInfoTable({ trips, onUpdate }) {
          ...
          {selectedTrip && (
            <Grid container spacing={2} sx={{ mt: 1 }}>
              <Grid item xs={12} sm={6}>
                ...
                <Typography variant="body1">T{selectedTrip.id.slice(-8).toUpperCase()}</Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12} sm={6}>
                ...
                <Typography variant="body1">{selectedTrip.passenger_count || 0} passengers</Typography>
              </Grid>
              <Grid item xs={12} sm={6}>

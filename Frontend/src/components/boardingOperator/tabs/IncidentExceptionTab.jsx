...
export default function IncidentExceptionTab() {
  ...
  return (
    <Box>
      <DashboardCard title="Report Incident / Exception" variant="outlined" action={<Button variant="contained" onClick={submit}>Submit</Button>}>
      ...
      <Box sx={{ mt: 2 }}>
        <DashboardCard title="Recent Incidents" variant="outlined">
          <DataTable
            data={rows}
            columns={[
